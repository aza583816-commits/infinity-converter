...
from core.tool_registry import PREMIUM_TOOL_IDS, TOOLS, _meta_for
...
def create_app() -> Flask:
    ...
    def inject_i18n():
        ...
        return {
            ...
            # Provider details intentionally stay server-side; the public product is Infinity AI.
            ...
            "organization_schema": {
                ...
                "name": "Infinity Converter",
                "url": settings.public_base_url,
                "logo": f"{settings.public_base_url}/static/icon-512.png?v=6.1.2",
