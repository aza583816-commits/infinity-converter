...
## 6.1.0 release candidate

See `FINAL_RELEASE_AUDIT_6.1.0.md` for the verification matrix and known deployment-time checks, `RELEASE_NOTES_6.1.0.md` for the change summary, and `ADSENSE_READINESS.md` for the monetization-readiness checklist.
