...
def startup_routes():
    with tempfile.TemporaryDirectory(prefix="infinity-preflight-") as temp:
        ...
        with app.test_client() as client:
            ...
            if "infinity-static-v7.0.0" not in service_worker or "url.pathname.startsWith('/static/')" not in service_worker:
            ...
            print("AdSense/search quality + 7.0.0 experience guards OK")
